  ...
  return (
    <section>
      ...
      <div
        ...
        tabIndex="-1"
        className="mt-5 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full pt-28 justify-center items-center flex"
        aria-modal="true"
        role="dialog"
      >
